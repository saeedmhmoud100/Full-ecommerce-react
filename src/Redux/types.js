...
export let GET_ORDER_DETAILS='GET_ORDER_DETAILS';
export let CHANGE_ORDER_TO_PAID='CHANGE_ORDER_TO_PAID';
export let CHANGE_ORDER_TO_DELIVERED='CHANGE_ORDER_TO_DELIVERED';


// Admin Users types
export let GET_ALL_USERS='GET_ALL_USERS';
export let CHANGE_USER_ROLE='CHANGE_USER_ROLE';
export let DELETE_USER='DELETE_USER';
export let ADMIN_USERS_ERROR='ADMIN_USERS_ERROR';
