...
const CartItem = ({item,admin}) => {
    ...
    return (
        ...
        <Col xs="12" className="cart-item-body my-2 d-flex px-2 flex-sm-row flex-column cart-item-sm" >
            <Link to={`/Full-ecommerce-react/products/${item._id}`}>
            ...
            <div className="w-100 mx-3">
                ...
                <Row className="justify-content-center mt-2">
                    <Col sm="12" className=" d-flex flex-row justify-content-start">
                        ...
                        <div className="d-inline-flex  cat-rate me-2 mx-2 align-items-baseline ">
                            <span style={{marginRight:'3px'}}> {item &&item.product.ratingsAverage || 0}</span>
                ...
                <Row>
                    <Col sm="12" className="mt-1 d-flex">
                        <div
                            ...
                            style={{ backgroundColor: `${item &&item.color || '#000'}` }}></div>
                    </Col>
                </Row>
                ...
                <Row className="justify-content-between">
                    <Col sm="12" className="d-flex flex-sm-row flex-column justify-content-between">
                        ...
                        <div className="d-inline-flex align-items-center justify-content-center pt-2 barnd-text"><span>{item &&item.price ? `${item.count +' x ' + item.price+'$' + ' = ' + item.count*item.price}` : 0}$</span></div>
                    </Col>
                </Row>
            </div>
        </Col>
