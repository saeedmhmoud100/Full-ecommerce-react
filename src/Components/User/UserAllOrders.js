...
import UserAllOrderItemPlaceholder from "../Placeholders/UserAllOrderItemPlaceholder";

function UserAllOrders() {
    const [OrdersData,userData,getOrdersData,lod] = UserAllUserOrdersHook()
    return (
        <div>
